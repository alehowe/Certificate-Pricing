# Guidelines
This project presents an analysis and pricing of a certificate using financial modeling techniques. The study focuses on determining the upfront payment that a bank should receive under mid-market conditions. A detailed description of the problem and the methodologies employed can be found in the [report](https://github.com/alehowe/Certificate-Pricing/blob/main/Report_Certificate_Pricing.pdf).
